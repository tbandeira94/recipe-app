...
export function SettingsPage({ recipeCount, onImported }: Props) {
  ...
  return <div className="page">
    ...
    <section className="settings-card">
      ...
      <button className="settings-action" onClick={handleExport} disabled={busy}><span className="action-icon"><DownloadIcon /></span><span><strong>Export backup</strong><small>Save or share a readable JSON file</small></span><span aria-hidden="true">›</span></button>
    ...
    <p className="version-label">Pantry Book · Backup format v2</p>
  </div>
}
